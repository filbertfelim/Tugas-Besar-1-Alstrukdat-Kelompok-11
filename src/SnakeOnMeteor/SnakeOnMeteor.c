...
void SnakeOnMeteor(int *score)
{
    ...
    while (!isGameOver)
    {
        if (turn == 0)
        {
            ...
            printf(
            "  ______   ____  _____       _       ___  ____   ________       ___   ____  _____      ____    ____  ________  _________  ________    ___   _______                  ____ \n"
            ".' ____ \\ |_   \\|_   _|     / \\     |_  ||_  _| |_   __  |    .'   `.|_   \\|_   _|    |_   \\  /   _||_   __  ||  _   _  ||_   __  | .'   `.|_   __ \\                / . .\\ \n" 
            "| (___ \\_|  |   \\ | |      / _ \\      | |_/ /     | |_ \\_|   /  .-.  \\ |   \\ | |        |   \\/   |    | |_ \\_||_/ | | \\_|  | |_ \\_|/  .-.  \\ | |__) |               \\   ---< \n" 
            " _.____`.   | |\\ \\| |     / ___ \\     |  __'.     |  _| _    | |   | | | |\\ \\| |        | |\\  /| |    |  _| _     | |      |  _| _ | |   | | |  __ /                 \\  / \n"
            "| \\____) | _| |_\\   |_  _/ /   \\ \\_  _| |  \\ \\_  _| |__/ |   \\  `-'  /_| |_\\   |_      _| |_\\/_| |_  _| |__/ |   _| |_    _| |__/ |\\  `-'  /_| |  \\ \\_     __________/ / \n" 
            "\\______.'|_____|\\____| |____| |____||____||____||________|    `.___.'|_____|\\____|    |_____||_____||________|  |_____|  |________| `.___.'|____| |___| -=:___________/ \n\n"
            );
